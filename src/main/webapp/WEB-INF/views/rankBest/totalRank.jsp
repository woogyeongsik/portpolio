		...
		<div class="container">
			...
			<div class="dropdown">
				...
				<ul class="dropdown-menu">
					...
					<li><a
						href="${pageContext.request.contextPath}/rankBest-10.do">10대</a></li>
					<li><a
						href="${pageContext.request.contextPath}/rankBest-20.do">20대</a></li>
					<li><a
						href="${pageContext.request.contextPath}/rankBest-30.do">30대</a></li>
					<li><a
						href="${pageContext.request.contextPath}/rankBest-40.do">40대</a></li>
					<li><a
						href="${pageContext.request.contextPath}/rankBest-50.do">50대</a></li>
					<li><a
						href="${pageContext.request.contextPath}/rankBest-60.do">60대
							이상</a></li>
					<li role="separator" class="divider"></li>
