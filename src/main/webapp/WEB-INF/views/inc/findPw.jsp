...
<body cellpadding="0" cellspacing="0" marginleft="0" margintop="0" width="100%" height="100%" align="center">
  ...
  <div class="card align-middle" style="width:20rem; border-radius:20px; margin:auto;">
    ...
    <div class="card-body">
      <form class="form-signin" method="POST" onSubmit="logincall();return false" action="resetPw.jsp">
        ...
        <div class="eamil-div">
          ...
          <button class="getCheckNum" style="font-size:10px; position:absolute; left:210px; bottom:162px">인증번호 받기</button>
        </div>
        <br>
        <label for="checkedNum" class="sr-only">인증번호: </label>
        <input type="password" name="checkedNum" class="form-control" id="checkedNum" placeholder="인증번호(숫자 6개)" required>
        <br>
        <div class="checkbox">
        </div>
