...
<body>
	...
	<div class="container">
		...
		<h1>
			&emsp;<strong>게시판 정보 수정</strong>
		</h1>
		<hr style="border: solid 1px #eeeeee;">
		<!--  입력폼 -->
		<form method="post" id="add_form"
			action="${pageContext.request.contextPath }>board/manage_edit_ok.do">
			<table class="table" border="1">
				<tbody>
					...
					<tr>
						<th class="active text-center" style="width: 15%">비밀글 허용 여부</th>
						<td><label for="secret">공개&nbsp;</label> <input
							type="radio" name="secret" value="Y">&emsp;&emsp;<label
							for="secret">비공개&nbsp;</label><input type="radio" name="secret"
					...
					<tr>
						...
						<tr>
						<th class="active text-center" style="width: 15%">게시판 삭제 여부</th>
						<td ><label for="delete">공개&nbsp;</label> <input
							type="radio" name="delete" value="Y">&emsp;&emsp;<label
							for="delete">비공개&nbsp;</label><input type="radio" name="delete"
							value="N" checked="checked"></td>
					</tr>
				</tbody>
			</table>
			<div class=" button_group text-right">
				<button id="btn1" class="btn btn-primary" type="submit">수정</button>
	...
	<script type="text/javascript">
		...
		$("#btn1").click(function() {
			swal({
				...
				if (result.value) {
					window.location = "manage_edit_ok.do";
				}
			});
		});
		$(function() {
