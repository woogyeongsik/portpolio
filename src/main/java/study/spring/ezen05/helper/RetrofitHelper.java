...
public class RetrofitHelper {
	...
	public Retrofit getRetrofit(String baseUrl) {
		...
		// -> import okhttp3.logging.HttpLoggingInterceptor.Leval;
		logging.level(Level.BODY);
		httpClientBuilder.addInterceptor(logging);
		
		//MyIntercepter 클래스의 객체를 통신객체에 연결한다. 
		httpClientBuilder.addNetworkInterceptor(new MyIntercepter());

		// bulider를 통해 통신객체 생성 --> import okhttp3.OkHttpClient;
